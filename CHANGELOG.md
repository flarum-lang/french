...
Journal de toutes les modifications : [v5.0.4...v5.0.5](https://github.com/flarum-lang/french/compare/v5.0.4...v5.0.5).
...
* Suppression des traductions obsolètes du noyau de Flarum (la version `2.0` ou supérieure est prise en charge).
* Suppression des traductions obsolètes du composant de validation de Laravel (la version `2.0` ou supérieure est prise en charge).
...
**Mise à jour ou suppression des traductions obsolètes de certaines extensions**:
...
**Abandon de la prise en charge d'extensions devenues obsolètes**:
...
Journal de toutes les modifications : [v4.29.1...v5.0.0](https://github.com/flarum-lang/french/compare/v4.29.1...v5.0.0).
...
* Mise à jour des traductions du noyau de Flarum.
* Mise à jour des traductions du composant de validation de Laravel.
