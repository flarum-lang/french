...
### [French Extension 0.1.0-dev (Build 11) Release](https://github.com/maelsoucaze/flarum/releases/tag/0.1.0-dev-build.11)
...
### [Latest French Extension Development Build](https://github.com/maelsoucaze/flarum/archive/master.zip)
